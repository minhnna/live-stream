package vn.minhnna.livestream.config;
...
@Configuration
@EnableMongoRepositories("vn.minhnna.livestream.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("vn.minhnna.livestream.config.dbmigrations");
